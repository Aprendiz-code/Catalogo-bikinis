...
const gafasCatalog = [
  ...
  { name: "Bvlgari", material: "Bvlgari", price: 95000, sizes: [], description: "Bvlgari", image_url: gafasImageMap[27] },
  ...
  { name: "Dolce & Gabbana", material: "Dolce & Gabbana", price: 95000, sizes: [], description: "Dolce & Gabbana", image_url: gafasImageMap[35] },
  { name: "Prada", material: "Prada", price: 95000, sizes: [], description: "Prada", image_url: gafasImageMap[36] },
  { name: "Louis Vuitton", material: "Louis Vuitton", price: 95000, sizes: [], description: "Louis Vuitton", image_url: gafasImageMap[37] },
  { name: "Louis Vuitton", material: "Louis Vuitton", price: 95000, sizes: [], description: "Louis Vuitton", image_url: gafasImageMap[38] },
  { name: "Gafas Demo 39", material: "Material demo", price: 95000, sizes: [], description: "Referencia demo", image_url: gafasImageMap[39] },
  { name: "Louis Vuitton", material: "Louis Vuitton", price: 95000, sizes: [], description: "Louis Vuitton", image_url: gafasImageMap[40] },
  { name: "Bvlgari", material: "Bvlgari", price: 95000, sizes: [], description: "Bvlgari", image_url: gafasImageMap[41] },
  { name: "Marc Jacobs", material: "Marc Jacobs", price: 95000, sizes: [], description: "Marc Jacobs", image_url: gafasImageMap[42] },
];
...
export const mockEditorialPages: CatalogPage[] = [
  ...
  },
  {
    ...
    subtitle: "Síguenos en redes sociales y descubre nuestras novedades, nuevos diseños y promociones especiales.",
    body: "Esperamos que encuentres el bikini perfecto para disfrutar cada momento bajo el sol.",
    background_color: "#D8C2B3",
    text_color: "#FFFAF4",
